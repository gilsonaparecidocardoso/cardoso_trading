...
class MoedasImportView(ListView):
    model = Moedas #Procura o nome da APP e o nome do modelo
    def getcoins(request):
        print('MoedasImportViewMMoedasImportViewoedasImportView?')
        if request.method == 'POST':
            ...
            print ('passou7')
            return redirect('moedas2_list', {'coin_list': coin_list})
